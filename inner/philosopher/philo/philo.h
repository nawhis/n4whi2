...
/*   Updated: 2024/01/26 11:48:45 by sihkang          ###   ########seoul.kr  */
/*                                                                            */
/* ************************************************************************** */
...
int				philo_init(t_tt *st, pthread_mutex_t *fork, \
...
int				mutex_init(pthread_mutex_t *time, \
				pthread_mutex_t *cnt_eat_mutex, pthread_mutex_t *print_mutex);
void			count_eat(t_tt *philo_st);
